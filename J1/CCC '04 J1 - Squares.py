# Gigi likes to play with squares.
# She has a collection of equal-sized square tiles.
# Gigi wants to arrange some or all of her tiles on a table to form a solid square.
...
numTiles = int(input())
sqrt = int(numTiles ** 0.5)
print("The largest square has side length %s."%(sqrt))