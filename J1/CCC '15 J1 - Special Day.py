...
#
# Write a program that asks the user for a numerical month and numerical day of the month and
# then determines whether that date occurs before, after, or on February 18.
#
...
#
# The first line will contain the month, which will be an integer in the range
# from 1 (indicating January) to 12 (indicating December).
#
