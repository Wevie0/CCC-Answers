...
#
# Mahima has been experimenting with a new style of art. She stands in front of a canvas and, using her brush,
# flicks drops of paint onto the canvas. When she thinks she has created a masterpiece,
# she uses her 3D printer to print a frame to surround the canvas.
# Your job is to help Mahima by determining the coordinates of the smallest possible rectangular frame
# such that each drop of paint lies inside the frame. Points on the frame are not considered inside the frame.

# Input Specification
# The first line of input contains the number of drops of paint, N,
# where 2 ≤ N ≤ 100 and N is an integer. Each of the next N lines contain exactly two positive integers X and Y
# separated by one comma (no spaces).
